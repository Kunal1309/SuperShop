        ...
        <div className="container-xxl">
          <div className="row">
            ...
            <div className="col-4">
              ...
              <div className="footer-links d-flex flex-column">
                <Link to={`/category/electronics`} className="text-white py-2 mb-1">Electronics</Link>
                <Link to={`/category/clothes`} className="text-white py-2 mb-1">Clothes</Link>
                <Link to={`/category/sports`} className="text-white py-2 mb-1">Sports</Link>
                <Link to={`/category/furniture`} className="text-white py-2 mb-1">Furniture</Link>
              </div>
            </div>
          </div>
        </div>
